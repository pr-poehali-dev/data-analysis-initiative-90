      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              <p>Более 25 лет я помогаю людям восстановить связь с собой — телом, душой и разумом. Мой путь объединяет онтологию, прикладную кинезиологию, интегративные методы психологии, гештальт подход и остеопатические принципы в единый экологичный путь к исцелению.</p>
              <p>Я убеждён: тело обладает природной мудростью и способностью к самовосстановлению. Моя задача — помочь человеку найти естественный путь к подлинной целостности, жизненной силе и здоровью.</p>
              <p>Принимаю в Уфе, помогаю справиться с самыми разными жизненными трудностями — хронические и острые боли, усталость, трудные эмоциональные состояния, потеря смысла жизни и др.</p>
            </div>
