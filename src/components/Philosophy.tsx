      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              <p>Более 25 лет я помогаю людям восстановить связь с собой — телом, душой и разумом. Мой путь объединяет онтологию, прикладную кинезиологию, интегративные методы психологии, гештальт-терапию и остеопатические принципы  в единый экологичный подход к исцелению.</p>
              <p>
